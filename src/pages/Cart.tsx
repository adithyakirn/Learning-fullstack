...
import { ShopContext, type cartItemData, type ShopContextType } from "../context/ShopContextValue"
...
const Cart = () => {
  ...
  const { products, currency, cartItems, updateQuantity, navigate } = useContext(ShopContext) as ShopContextType
